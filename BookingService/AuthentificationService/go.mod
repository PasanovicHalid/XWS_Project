module github.com/PasanovicHalid/XWS_Project/BookingService/AuthentificationService
...
require (
	github.com/PasanovicHalid/XWS_Project/BookingService/SharedLibraries/Saga v0.0.0-00010101000000-000000000000
